...
export default function App(){
  ...
  async function evaluar(){
    ...
    try{
      ...
      setHumedal(hum);setSg(soil);setProtegida(prot);setPendiente(pend);setExtras(ext||{activas:{},estado:{}});setFase("resultado");
    }catch(e){setError(e.message||"error");setFase("resultado");}
  }
  function reiniciar(){setPuntos([]);setFase("mapa");setClima(null);setAgua(null);setSuelo(null);setSuelosMulti([]);setHumedal(null);setSg(null);setProtegida(null);setPendiente(null);setExtras({activas:{},estado:{}});setCentro(null);setError(null);setBib(false);}
      ...
      {modo==="diseno"?(
        <>
          ...
          {clima&&(<>
            ...
            {!((humedal&&humedal.esHumedal)||(protegida&&protegida.protegida)||(pendiente&&pendiente.ok&&pendiente.estado==="veto")||(extras&&extras.activas&&Object.keys(extras.activas).length>0))&&(
