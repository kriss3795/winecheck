...
export default function App(){
  ...
  function reiniciar(){setPuntos([]);setFase("mapa");setClima(null);setAgua(null);setSuelo(null);setSuelosMulti([]);setHumedal(null);setSg(null);setProtegida(null);setPendiente(null);setExtras({activas:{},estado:{}});setCuerpoAgua(null);setPrecios(null);setEscasez(null);setCentro(null);setError(null);setBib(false);}
