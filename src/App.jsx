...
async function muestrearCapa(fn, sitios, clave){
  ...
  function reiniciar(){setPuntos([]);setFase("mapa");setClima(null);setAgua(null);setSuelo(null);setSuelosMulti([]);setHumedal(null);setSg(null);setProtegida(null);setPendiente(null);setExtras({activas:{},estado:{}});setCuerpoAgua(null);setEscasez(null);setAguaVar([]);setCentro(null);setError(null);setBib(false);}
      ...
      <div style={{display:"flex",flex:1,minHeight:0,flexDirection:esMovil?"column":"row"}}>
        <div style={{position:"relative",flexShrink:0,
          ...
          <MapContainer center={[-34.5,-71.2]} zoom={7} zoomControl={!esMovil} style={{height:"100%",width:"100%"}}>
            ...
            {capaBase==="topo"&&<TileLayer attribution='&copy; Esri' url="https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}" />}
