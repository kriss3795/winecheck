...
// Acceso seguro a CFG: si el estado es desconocido/undefined, usa "nd" (nunca crashea).
function cfg(estado){ return CFG[estado] || CFG.nd; }
...
function Tarjeta({titulo,estado,destacada,nota,children}){
  return(<div style={{border:destacada?"2px solid "+P.agua:"1px solid "+P.linea,
    borderLeft:"4px solid "+cfg(estado).color,borderRadius:10,padding:"14px 16px",background:P.panel,marginBottom:12}}>
