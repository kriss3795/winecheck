...
export async function handler(event) {
  ...
  const permitidos = ["esri.ciren.cl", "rest-sit.mop.gob.cl", "rest-sit.mop.gov.cl", "arcgis.mma.gob.cl", "gis.mma.gob.cl", "rest.isric.org", "ideserver.sma.gob.cl", "api.open-meteo.com", "ide.minagri.gob.cl", "geoserver.conaf.cl", "arcgis.conaf.cl", "datos.odepa.gob.cl", "overpass-api.de", "overpass.kumi.systems"];
